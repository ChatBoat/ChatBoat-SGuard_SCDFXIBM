...
export function BotProvider({children}){
	const startCall = () => {
		RNTwilioPhone.startCall('sips:+19285971659@public.voip.jp-tok.assistant.watson.cloud.ibm.com','SGuardianBot',identity,{
			secret:'hello world'
		});
	};
	const endCall = () => {
	...
	return (
		<BotContext.Provider value={{startCall, endCall}}>
			{children}
		</BotContext.Provider>
	);
}